...
// Versión sencilla y abierta para asegurar que funcione con front local y Vercel.
// Luego, si quieres, volvemos a la versión con allowedOrigins.
app.use(cors());

// Si quieres usar tu lógica más fina de CORS por entorno, déjala así:
// (opcional, pero NO dupliques después con más app.use(cors(...)))
